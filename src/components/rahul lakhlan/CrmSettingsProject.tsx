import { FilterIcons, SearchIcons } from "../common/Icons";
import Newestbtndropdown from "../yash/Newestbtndropdown";
    ...
    <>
      <div className="max-w-[1244px] w-full mx-auto p-6 flex max-md:flex-col gap-6 justify-between">
        ...
        <div className="flex max-sm:flex-wrap gap-6 max-sm:gap-2 items-center justify-center max-w-[444px] w-full">
          <button
            type="submit"
            className="flex gap-2 justify-center items-center max-w-[120px] w-full h-[48px] rounded-lg border-[2px] border-[#F4ECFF] hover:bg-transparent bg-[#F4ECFF] duration-300 text-[#A565FF] font-bold text-[16px] font-Manrope">
            <FilterIcons />
            Filter
          </button>
          <div>
